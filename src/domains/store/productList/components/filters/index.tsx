...
const Filters = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "lg:min-w-[220px] w-[310px] ease-TechX-easeOut transition-all pb-8 duration-500 lg:w-auto max-w-[260px] absolute lg:relative h-full px-5 border-r bg-white lg:z-1 z-20 border-gray-300 overflow-y-scroll",
      ...
      >
        ...
        <Button
          ...
          className="w-full py-1 text-sm rounded-md text-gray-100 border-none bg-TechX-blue-500 hover:bg-TechX-blue-600 active:bg-TechX-blue-400 disabled:bg-TechX-blue-700"
